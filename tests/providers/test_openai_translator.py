...
class TestBirkenbilhMethodCompliance:
    ...
    def test_complex_multi_sentence_word_alignments(self, translator: OpenAITranslator):
        ...
        complex_text = (
            "Even though I had never been to Paris before, I felt strangely familiar with the streets. "
            "The students who had completed all their assignments on time were allowed to leave early. "
            "If I were rich, I would travel around the world and learn many different languages."
        )
        result = translator.translate(complex_text, "en", "de")
