...
class TestSplitIntoSentences:
    ...
    def test_newline_between_sentences(self) -> None:
    ...
    def test_complex_text_with_numbers(self) -> None:
...
class TestRedistributeMergedTranslation:
    ...
    def test_simple_two_sentence_split(self) -> None:
    ...
    def test_three_sentence_split(self) -> None:
    ...
    def test_mismatch_sentence_count_raises_error(self) -> None:
    ...
    def test_unknown_source_word_raises_error(self) -> None:
