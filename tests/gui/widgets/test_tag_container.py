...
class TestTagContainer:
    ...
    def test_tags_shown_from_controller(self, qapp):
    ...
    def test_combobox_shows_available_words(self, qapp):
    ...
    def test_adding_word_updates_controller(self, qtbot, qapp):
    ...
    def test_removing_tag_updates_controller(self, qtbot, qapp):
    ...
    def test_combobox_disabled_when_no_words_available(self, qapp):
    ...
    def test_refresh_on_controller_signal(self, qtbot, qapp):
    ...
    def test_multiple_tags_shown(self, qapp):
    ...
    def test_combobox_resets_after_selection(self, qtbot, qapp):
    ...
    def test_combobox_excludes_assigned_words(self, qapp):
