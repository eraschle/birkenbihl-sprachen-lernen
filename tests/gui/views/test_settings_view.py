...
class TestProviderDialog:
    ...
    def test_auto_name_generation_on_init(self, qtbot: QtBot) -> None:
    ...
    def test_auto_name_updates_when_model_changes(self, qtbot: QtBot) -> None:
    ...
    def test_auto_name_updates_when_provider_type_changes(self, qtbot: QtBot) -> None:
    ...
    def test_auto_generated_name_used_in_provider(self, qtbot: QtBot) -> None:
    ...
    def test_validation_fails_when_model_empty(self, qtbot: QtBot) -> None:
